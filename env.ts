 ...
 */
export function replacePortsInEnvContent(
  content: string,
 ...
 */
export async function backupEnvFile(envPath: string): Promise<string> {
 ...
 */
export async function restoreEnvFile(envPath: string): Promise<boolean> {
  const backupPath = envPath + ENV_BACKUP_SUFFIX;
